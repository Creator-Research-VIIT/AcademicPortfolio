...
import { FaDatabase, FaGlobe } from 'react-icons/fa'; // Scopus & Web of Science
        ...
        <div>
          ...
          <div className="space-y-3 text-sm mb-4">
            <div className="flex items-center gap-2 text-amber-200">
              <Mail size={16} />
              <Link href="mailto:anup.ingle@vit.edu" className="hover:text-amber-400 transition">
                anup.ingle@vit.edu (Official)
              </Link>
            </div>
            <div className="flex items-center gap-2 text-amber-200">
              <Mail size={16} />
              <Link href="mailto:anupingle@gmail.com" className="hover:text-amber-400 transition">
